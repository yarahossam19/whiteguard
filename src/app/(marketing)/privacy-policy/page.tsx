...
export default function PrivacyPolicyPage() {
  return (
    <div className="container py-16 lg:my-24">
        ...
        <div className="space-y-10 font-jakarta text-[#52697A]">
          <section>
            ...
            <p className="leading-relaxed">
              ...
              platform, services, or interact with us (collectively, the
          ...
          <section>
            ...
            <ul className="list-inside list-disc space-y-2 pl-2 leading-relaxed">
              <li>
                <strong className="text-[#003859]">
                  Personal Information:
                </strong>{" "}
                Name, email address, phone number, job title, company name, and
                other contact details when you register, request a consultation,
              ...
              <li>
                ...
                when you access our website or platform.
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="list-inside list-disc space-y-2 pl-2 leading-relaxed">
              ...
              <li>
                Send important updates, security alerts, and service-related
                communications
              </li>
              <li>Respond to your inquiries and provide customer support</li>
              <li>
                Analyze usage patterns to enhance our platform and user
                experience
              </li>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              operating and improving our business; and (d) compliance with
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              confidentiality agreements; (b) legal or regulatory authorities
              when required by law; (c) business partners or affiliates in
              connection with your engagement; and (d) in connection with a
