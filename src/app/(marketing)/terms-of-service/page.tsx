        ...
        <div className="space-y-10 font-jakarta text-[#52697A]">
          ...
          <section>
            ...
            <p className="mb-4 leading-relaxed">
              ...
              manage, and scale their cybersecurity programs.
            </p>
            <p className="leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-inside list-disc space-y-2 pl-2 leading-relaxed">
              ...
              <li>
                Use the Services to conduct or facilitate any malicious or
                illegal activity
              </li>
              <li>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              proprietary or sensitive information exchanged in connection with
              the Services. Our collection, use, and protection of personal data
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              these Terms or the Services shall not exceed the fees paid by you
              for the relevant Services in the twelve (12) months preceding the
              claim.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              revised Terms. For significant changes, we may provide additional
              notice by email or through our platform.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="leading-relaxed">
              ...
              time for violation of these Terms, non-payment, or for any other
              reason at our discretion. Upon termination, your right to use the
              Services ceases immediately. Provisions that by their nature
              should survive termination (including intellectual property,
              confidentiality, limitation of liability, and indemnification)
              shall survive.
            </p>
          </section>
