...
export default function HeroSection({ data, logos }: HeroSectionProps) {
  ...
  return (
    <section className="relative w-full overflow-hidden  ">
      <div className=" flex flex-col-reverse xl:flex-row  min-h-[50vh] lg:min-h-screen">
        {/*  LEFT CONTENT */}
        ...
        {/* ─── RIGHT PANEL ─── */}
        <div
          className="relative  inset-y-[-5vh] xl:inset-0 z-10 w-full xl:w-[50%] min-[1600px]:w-[50%]! min-h-[50vh] lg:min-h-screen     "
          style={{
