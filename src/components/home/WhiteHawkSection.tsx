  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex max-w-[520px] flex-col gap-8">
          <div className="flex flex-col gap-4">
            ...
            <h2 className="font-jakarta text-[clamp(28px,4vw,44px)] font-extrabold leading-[1.15]">
              ...
              <span className="text-[#0087D7]">Innovation.</span>
            </h2>
          </div>

          <p className="font-jakarta text-base font-normal leading-[1.8] text-white">
            {description}
          </p>
        ...
        <div className="relative w-full max-w-[544px] shrink-0 overflow-hidden rounded-lg">
