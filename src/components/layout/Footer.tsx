...
export function Footer() {
  return (
    <footer className="bg-navy py-12 text-white lg:py-16 xl:pt-[65px] xl:pb-6">
      <div className="container ">
        ...
        <div className="grid gap-8 lg:grid-cols-6 lg:gap-14">
          ...
          <div className="lg:col-span-2  text-center lg:text-left flex flex-col items-center lg:items-start ">
            ...
            <p className="mb-6 max-w-sm text-sm leading-relaxed text-[#9bb4e6]">
              {siteConfig.tagline}
            </p>
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="flex size-11 items-center justify-center rounded-[var(--r-sm)] text-white transition-colors duration-150 hover:bg-white/10"
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t border-white/15 pt-5 sm:flex-row">
          <p className="text-sm text-[#9bb4e6]">
          ...
          <div className="flex gap-6">
            {footerLegal.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="inline-flex min-h-[44px] items-center rounded-[var(--r-sm)] px-2 text-sm text-[#9bb4e6] transition-colors duration-150 hover:text-white"
              >
                {link.label}
              </Link>
            ))}
