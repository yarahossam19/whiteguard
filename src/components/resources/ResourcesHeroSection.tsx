      ...
      <section className="relative w-full overflow-hidden">
        ...
        >
          ...
          <div className="container relative z-10 flex flex-col items-center gap-4 text-center">
            ...
            {/* Decorative icons  */}
            <div
              className="pointer-events-none absolute -left-[3%] xl:left-[2%]  top-[50%] -translate-y-1/2 hidden h-[73px] w-[77px] lg:block"
              aria-hidden
            >
              <Image
            ...
            <div
              className="pointer-events-none absolute xl:right-[2%] -right-[3%] top-[50%] -translate-y-1/2 hidden h-[81px] w-[80px] lg:block"
              aria-hidden
            >
              <Image
