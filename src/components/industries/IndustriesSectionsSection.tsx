  ...
  return (
    <section className="relative w-full bg-white py-12 sm:py-16 lg:py-24">
      <div className="container">
        ...
        <div className="relative flex flex-col items-stretch justify-center gap-10 md:gap-14 lg:flex-row lg:items-start lg:gap-12 lg:gap-20">
          {/* Sticky left nav - circles - scrolls with page, click scrolls to section */}
          <div className="sticky top-24 z-20 hidden shrink-0 self-start lg:block lg:w-[200px] lg:w-[220px]">
            <nav
                    ...
                    >
                      ...
                      <div className="flex min-h-0 w-full min-w-0 flex-1 flex-col justify-between md:max-w-[54%] lg:max-w-none lg:min-h-[min(600px,70vh)]">
                        ...
                        <HoverSwapButton
                          ...
                          variant="cta"
                          showChevrons={false}
                          className="w-full mt-5 lg:mt-0 md:w-auto text-sm   lg:text-lg  font-ano"
                        />
                      </div>
                    </motion.article>
                  </div>
